        ...
        <div className="relative px-4 sm:px-6 lg:px-8">
            <div className="text-lg max-w-prose mx-auto">
                ...
                <p className="mt-8 text-xl text-gray-500 leading-8">
                    Typescript Vue Javascript Kotlin React
                </p>
                <p className="flex mt-8 text-lg text-gray-500 leading-8">
                    <span>
            ...
            <div className="mt-6 prose prose-indigo prose-lg text-gray-500 mx-auto">
                <p>
                    Sono un appassionato sviluppatore software alla costante ricerca di crescita professionale e personale. Dal 2015 lavoro nel settore e ho affrontato tutto lo stack di applicativi web e mobile. Negli ultimi anni mi sono maggiormente focalizzato sul frontend.
                    Applicazioni web e mobile, in tutti i suoi formati: dai 7 ai 77 pollici, su piattaforme Web-Browser, mobile, embedded e tv. Dispongo al 110% di:
                    -	determinazione al raggiungimento di obbiettivi chiari e tangibili,
                    -	continuo e costante miglioramento nell’universo dell’IT,
